...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/20 20:10:09 by lfrancav &        #+#    #+#             */
/*   Updated: 2024/02/20 20:10:39 by lfrancav &       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	setup_exec(t_expression *exp, t_env **envs)
{
	...
	if (ft_strcmp(exp->value, "goat"))
		return (write(1, "beeeeeeee\n", 10) * 0);
	if (ft_strcmp(exp->value, "whoisthegoat"))
		return (write(1, "you are the GOAT!\n", 18) * 0);
